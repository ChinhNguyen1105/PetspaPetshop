...
export class UserServiceImpl implements UserService {
  ...
  private async checkExistedUserByEmail(
    email: string,
  ): Promise<void> {
    const exists =
      await this.userRepository
        .existsByEmailAndDeleteFlagFalse(email);
  ...
  async createUser(
    ...
    await this.checkExistedUserByEmail(
      userCreateDto.email,
    );

    const createUser =
      this.userMapper.toUser(userCreateDto);
  ...
  async updateUser(
    ...
    updateUser.gender =
      userUpdateDto.gender as GenderEnum;
  ...
  async getAllUser(
    ...
    const result =
      this.userMapper.toUserDtos(users);
  ...
  async updateProfile(
    ...
    currentUser.name =
      reqUserUpdateProfile.name;

    currentUser.dateOfBirth =
      reqUserUpdateProfile.dateOfBirth;

    currentUser.gender =
      reqUserUpdateProfile.gender as GenderEnum;
