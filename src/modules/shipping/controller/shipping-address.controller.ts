...
export class ShippingAddressController {
  ...
  @Patch(
    UrlConstant.ShippingAddress.SET_DEFAULT_ADDRESS.replace(
      '{id}',
      ':id',
    ),
  )
  async setDefaultShippingAddress(
    ...
    return VsResponseUtil.successWithStatus(
      HttpStatus.OK,
      await this.service.setDefaultShippingAddress(
        id,
      ),
    );
  }
  ...
  @Post(
    UrlConstant.ShippingAddress.CREATE_SHIPPING_ADDRESS,
  )
  async createShippingAddress(
    @Body() req: ReqCreateShippingAddressDto,
  ) {
    return VsResponseUtil.successWithStatus(
      HttpStatus.OK,
  ...
  @Put(
    UrlConstant.ShippingAddress.UPDATE_SHIPPING_ADDRESS,
  )
  async updateShippingAddress(
    @Body() req: ReqUpdateShippingAddressDto,
  ) {
    return VsResponseUtil.successWithStatus(
      HttpStatus.OK,
  ...
  @Delete(
    UrlConstant.ShippingAddress.DELETE_SHIPPING_ADDRESS.replace(
      '{id}',
      ':id',
    ),
  )
  ...
  @Get(
    UrlConstant.ShippingAddress.GET_SHIPPING_ADDRESSES,
  )
